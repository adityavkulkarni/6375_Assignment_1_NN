...
#python main.py --dataset   heart --activation sigmoid --optimizer adagrad --gradient stochastic --learning-rate 0.008 --epochs 800
...
#python main.py --dataset   heart --activation tanh --optimizer adagrad --gradient minibatch --learning-rate 0.001 --epochs 200
...
#python main.py --dataset   heart --activation relu --optimizer adagrad --gradient minibatch --learning-rate 0.0003 --epochs 100
#python main.py --dataset   heart --activation relu --optimizer momentum --gradient minibatch --learning-rate 0.007 --epochs 500
